                    ...
                    ?>
                        <tr  class="configuration">
                          ...
                          <td class="td-actions text-right">
                              <a type="button" rel="tooltip" title="Edit Server" href="edit_willdev_subscription.php?edit=<?php echo $row['id']?>" class="btn btn-primary btn-link btn-sm" style="background-color: #0000FF; color: #FFF; font-style: normal;">
